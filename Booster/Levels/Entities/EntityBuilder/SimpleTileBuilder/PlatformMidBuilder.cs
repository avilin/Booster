...
{
    public class PlatformMidBuilder : ISimpleTileBuilder
    {
        private SimpleTile platform;
        private Resources resources;

        public PlatformMidBuilder(Resources resources, Vector2 position)
        {
        ...
        {
            platform.SourceRect = resources.SpriteSheets["tiles"].ObjectLocation["snowHalfMid.png"];
        }
