...
{
    public class BlockCenterBuilder : ISimpleTileBuilder
    {
        private SimpleTile block;
        private Resources resources;

        public BlockCenterBuilder(Resources resources, Vector2 position)
        {
        ...
        {
            block.SourceRect = resources.SpriteSheets["tiles"].ObjectLocation["snowCenter.png"];
        }
