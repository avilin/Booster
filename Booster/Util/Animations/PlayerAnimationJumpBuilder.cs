...
{
    public class PlayerAnimationJumpBuilder : IAnimationBuilder
    {
        private Animation animation = new Animation();
        private Resources resources;

        public PlayerAnimationJumpBuilder(Resources resources, Vector2 position)
        {
        ...
        public void BuildFrames()
        {
            ...
            frames.Add(new Frame(resources.SpriteSheets["p1"].ObjectLocation["p1_jump.png"], 1000));
